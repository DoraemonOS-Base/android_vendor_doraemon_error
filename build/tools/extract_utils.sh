...
# $1: device name
# $2: vendor name
# $3: doraemon root directory
# $4: is common device - optional, default to false
# $5: cleanup - optional, default to true
# $6: doraemon vendor makefile name - optional, default to false
#
...
function setup_vendor() {
    ...
    if [ ! -d "$DORAEMON_ROOT" ]; then
        echo "\$DORAEMON_ROOT must be set and valid before including this script!"
        exit 1
    fi
